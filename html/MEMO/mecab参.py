...
#記事
article1 = soup.select_one("span[class*=title]").text
article2 = soup.select_one("small[class*=day]").text
article3 = soup.select_one("small[class*=number]").text
...
last = [text1, text2, text3, text4, text5, text6, text7, text8, text9, text10, article1, article2, article3]#, article4, article5]
    ...
    while node :
        ...
        if len(feature_list)== 9:
            ...
            if origin != "" and matchOB:
                ...
                if origin[num1-1] == kana[num2-1] and origin[num1-2] == kana[num2-2] and origin[num1-4] == kana[num2-4] :
                ...
                elif origin[num1-1] == kana[num2-1] and origin[num1-2] == kana[num2-2] :
