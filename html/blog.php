...
<body>
  ...
  <a href="blog-r.php"><span style="position: absolute; left: 160px; top: 5px; font-family: serif; font-weight: 800;">ふりがなをつける</span></a>
  ...
  <div class="container">
    ...
    <div class="fnavi">
      ...
      <div class="right">
        <ul>
          <li>
            <img src="image/pink-star.png" height="50px" width="50px" style="margin-bottom: 5px;"><span style="color: black;">サイトマップ</span>
          </li>
          <li>
